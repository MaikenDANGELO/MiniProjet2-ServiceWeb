...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, getQuery as getQuery$1, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getResponseStatusText } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/h3/dist/index.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import destr from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/ufo/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/unhead/dist/server.mjs';
import { isVNode, toValue, isRef } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/vue/index.mjs';
import { walkResolver } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/unhead/dist/utils.mjs';
import { renderToString } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/scule/dist/index.mjs';
import { stringify, uneval } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/devalue/index.js';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/unhead/dist/plugins.mjs';
import { createHooks } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/youch-core/build/index.js';
import { Youch } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/errx/dist/index.js';
import BaseStyle from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primevue/core/base/style/index.mjs';
import BaseComponentStyle from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primevue/core/basecomponent/style/index.mjs';
import { style } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/autocomplete/index.mjs';
import { isNotEmpty, isEmpty } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/utils/object/index.mjs';
import { style as style$1 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/cascadeselect/index.mjs';
import { style as style$2 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/checkbox/index.mjs';
import { style as style$3 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/checkboxgroup/index.mjs';
import { style as style$4 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/colorpicker/index.mjs';
import { style as style$5 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/datepicker/index.mjs';
import { style as style$6 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/floatlabel/index.mjs';
import { style as style$7 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/iconfield/index.mjs';
import { style as style$8 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/iftalabel/index.mjs';
import { style as style$9 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/inputchips/index.mjs';
import { style as style$a } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/inputgroup/index.mjs';
import { style as style$b } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/inputnumber/index.mjs';
import { style as style$c } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/inputotp/index.mjs';
import { style as style$d } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/inputtext/index.mjs';
import { style as style$e } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/knob/index.mjs';
import { style as style$f } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/listbox/index.mjs';
import { style as style$g } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/multiselect/index.mjs';
import { style as style$h } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/password/index.mjs';
import { style as style$i } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/radiobutton/index.mjs';
import { style as style$j } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/radiobuttongroup/index.mjs';
import { style as style$k } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/rating/index.mjs';
import { style as style$l } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/select/index.mjs';
import { style as style$m } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/selectbutton/index.mjs';
import { style as style$n } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/slider/index.mjs';
import { style as style$o } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/textarea/index.mjs';
import { style as style$p } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/togglebutton/index.mjs';
import { style as style$q } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/toggleswitch/index.mjs';
import { style as style$r } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/treeselect/index.mjs';
import { style as style$s } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/button/index.mjs';
import { style as style$t } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/buttongroup/index.mjs';
import { style as style$u } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/speeddial/index.mjs';
import { style as style$v } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/splitbutton/index.mjs';
import { style as style$w } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/datatable/index.mjs';
import { style as style$x } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/dataview/index.mjs';
import { style as style$y } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/orderlist/index.mjs';
import { style as style$z } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/organizationchart/index.mjs';
import { style as style$A } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/paginator/index.mjs';
import { style as style$B } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/picklist/index.mjs';
import { style as style$C } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/tree/index.mjs';
import { style as style$D } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/treetable/index.mjs';
import { style as style$E } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/timeline/index.mjs';
import { style as style$F } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/virtualscroller/index.mjs';
import { style as style$G } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/accordion/index.mjs';
import { style as style$H } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/card/index.mjs';
import { style as style$I } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/divider/index.mjs';
import { style as style$J } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/fieldset/index.mjs';
import { style as style$K } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/panel/index.mjs';
import { style as style$L } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/scrollpanel/index.mjs';
import { style as style$M } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/splitter/index.mjs';
import { style as style$N } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/stepper/index.mjs';
import { style as style$O } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/tabview/index.mjs';
import { style as style$P } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/tabs/index.mjs';
import { style as style$Q } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/toolbar/index.mjs';
import { style as style$R } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/confirmdialog/index.mjs';
import { style as style$S } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/confirmpopup/index.mjs';
import { style as style$T } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/dialog/index.mjs';
import { style as style$U } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/drawer/index.mjs';
import { style as style$V } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/popover/index.mjs';
import { style as style$W } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/fileupload/index.mjs';
import { style as style$X } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/breadcrumb/index.mjs';
import { style as style$Y } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/contextmenu/index.mjs';
import { style as style$Z } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/dock/index.mjs';
import { style as style$_ } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/menu/index.mjs';
import { style as style$$ } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/menubar/index.mjs';
import { style as style$10 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/megamenu/index.mjs';
import { style as style$11 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/panelmenu/index.mjs';
import { style as style$12 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/steps/index.mjs';
import { style as style$13 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/tabmenu/index.mjs';
import { style as style$14 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/tieredmenu/index.mjs';
import { style as style$15 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/message/index.mjs';
import { style as style$16 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/inlinemessage/index.mjs';
import { style as style$17 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/toast/index.mjs';
import { style as style$18 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/carousel/index.mjs';
import { style as style$19 } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/galleria/index.mjs';
import { style as style$1a } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/image/index.mjs';
import { style as style$1b } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/imagecompare/index.mjs';
import { style as style$1c } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/avatar/index.mjs';
import { style as style$1d } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/badge/index.mjs';
import { style as style$1e } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/blockui/index.mjs';
import { style as style$1f } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/chip/index.mjs';
import { style as style$1g } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/inplace/index.mjs';
import { style as style$1h } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/metergroup/index.mjs';
import { style as style$1i } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/overlaybadge/index.mjs';
import { style as style$1j } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/scrolltop/index.mjs';
import { style as style$1k } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/skeleton/index.mjs';
import { style as style$1l } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/progressbar/index.mjs';
import { style as style$1m } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/progressspinner/index.mjs';
import { style as style$1n } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/tag/index.mjs';
import { style as style$1o } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/terminal/index.mjs';
import FormStyle from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primevue/forms/form/style/index.mjs';
import FormFieldStyle from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primevue/forms/formfield/style/index.mjs';
import { style as style$1p } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/tooltip/index.mjs';
import { style as style$1q } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styles/ripple/index.mjs';
import { Theme } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@primeuix/styled/index.mjs';
import { basename } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/.nuxt/nuxt-icon-server-bundle.mjs';

const serverAssets = [{"baseName":"server","dir":"B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/.data/kv"}));
...
const _uY9RET838FcnmPrbvgYb9xtRqf9LZGDmgaSsFqtb_R4 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client";
...
const _UtIOmzBRz5GU0CE1e_M41joh6_FHaWRxB4DfXDnyk = (nitroApp) => {
...
const _4XWUbri4HHCmvP6iWahS3BmdPV_smBE5eLC11I24XGA = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _FaQB08nt9O94KD8AXDmRq1IJ4e9kgfB65ZNlT7boq48 = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _uY9RET838FcnmPrbvgYb9xtRqf9LZGDmgaSsFqtb_R4,
_UtIOmzBRz5GU0CE1e_M41joh6_FHaWRxB4DfXDnyk,
_4XWUbri4HHCmvP6iWahS3BmdPV_smBE5eLC11I24XGA,
_FaQB08nt9O94KD8AXDmRq1IJ4e9kgfB65ZNlT7boq48
];

const warnOnceSet = /* @__PURE__ */ new Set();
const DEFAULT_ENDPOINT = "https://api.iconify.design";
const _a65xEP = defineCachedEventHandler(async (event) => {
...
const _lazy_FgY91i = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_FgY91i, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _a65xEP, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_FgY91i, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_FgY91i, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://B:/Code/Ecole/MiniProjet2-ServiceWeb-main/client/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
